...
export default function EventSelector({ loading, error, onSubmit }: EventSelectorProps) {
  ...
  return (
    <section className="rounded-xl border border-[#E8E4DE] bg-white p-6">
      <h1 className="text-xl font-medium text-[#1A1A1A]">Import meetings</h1>
      <p className="mt-2 text-sm leading-6 text-[#6B6B6B]">
        Saisissez l’identifiant Eventmaker de l’événement à alimenter.
      </p>
